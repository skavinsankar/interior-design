				...
				<div class="row">
                    ...
                    <div class="col-md-5">
						<div class="product-details">
							...
							<p>Designer Details : </br>
							Name :xxxx</br>
							<Mobile class="No:">9798476678</Mobile></br>
							Location: CBE
							</p>
							...
							<div class="product-options">
								...
								<label>
									background Color
									<select class="input-select">
										<option value="0">Blue with marble surface</option>
										<option value="0">Gradient XXX</option>
										<option value="0">Marple</option>
									</select>
								</label>
							</div>
